...
public class DrawRoute extends AsyncTask<String, Void, String> implements DrawServiceCallback{

    private GoogleMap mMap;
    DrawCallback callback;

    public DrawRoute(GoogleMap mMap, DrawCallback callback) {
        this.mMap = mMap;
