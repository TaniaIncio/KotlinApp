...
public class RouteDrawerTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
    ...
    public ArrayList<LatLng> pointsAll = new ArrayList<>();
    DrawServiceCallback callback;

    public RouteDrawerTask(GoogleMap mMap, DrawServiceCallback callback) {
        this.mMap = mMap;
    ...
    private void drawPolyLine(List<List<HashMap<String, String>>> result) {
        ...
        callback.getAllPoints(pointsAll);
